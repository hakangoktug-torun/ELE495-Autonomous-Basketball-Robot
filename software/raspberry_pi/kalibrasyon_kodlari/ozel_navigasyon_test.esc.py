...
GUNCELLEME: ileri_git_sabit_sure artik PID kullaniyor (DUZELTME_KAZANCI_D
eklendi) - test_surus.py'deki ayni guncellemeyle tutarli, ani sapmalara
(ornegin tekerlek kaymasi) daha hizli tepki verir.
"""
...
from test_surus import (
    ...
    SOL_HIZ, SAG_HIZ, DUZELTME_KAZANCI, DUZELTME_KAZANCI_I, DUZELTME_KAZANCI_D,
    MAKS_DUZELTME, MAKS_INTEGRAL,
)
...
def ileri_git_sabit_sure(bridge, pwm_a, pwm_b, sure_saniye):
    ...
    olarak duzeltir (PID kontrolor - P+I+D).
    """
    ileri_yon_ayarla()
